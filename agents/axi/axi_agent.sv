...
package fusion_axi_pkg;
    ...
    class axi_driver extends uvm_driver #(axi_transaction);
        ...
        // DUT requires awvalid && wvalid simultaneously (both channels in same cycle)
        virtual task drive_write_transaction(axi_transaction trans);
            // Assert address and data channels simultaneously
            ...
            // Wait for both awready and wready (DUT drives these combinatorially)
            @(posedge vif.clk);
